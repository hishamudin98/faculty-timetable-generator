<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminRoom.aspx.cs" Inherits="timetable_workshop.adminRoom" %>
    ...
    <form id="form1" runat="server">
        ...
        <div id="printablediv">
            <div >
                ...
                <asp:DropDownList ID="DropDownList1" runat="server" Height="25px" Width="366px" AutoPostBack="True" DataSourceID="SqlDataSource3" DataTextField="Name" DataValueField="ID" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged"  >
                </asp:DropDownList>
                <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:Timetable_proConnectionString3 %>" SelectCommand="SELECT * FROM [Room]"></asp:SqlDataSource>
                <br />
                <br />
            </div>
            <br />
