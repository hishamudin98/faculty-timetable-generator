<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminLecturer.aspx.cs" Inherits="timetable_workshop.adminLecturer" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Check timetable lecturer</title>
...
<body class="body" >
    ...
    <form id="form1" runat="server">
        ...
        <div>
            ...
            <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="SqlDataSource2" DataTextField="Name" DataValueField="ID" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged1" Width="426px" AutoPostBack="True">
            </asp:DropDownList>
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:Timetable_proConnectionString3 %>" SelectCommand="SELECT [ID], [Name] FROM [Lecturer]"></asp:SqlDataSource>
        </div>
        <div id="printablediv">
            <div>
            &nbsp;&nbsp;&nbsp;
                ...
                <div class="w3-center">
                    ...
                    <a><asp:Image ID="Image1" Width="125px" Height="145px" runat="server" /></a>
                </div>

                <asp:Label ID="Label2" CssClass="w3-centered" runat="server" Font-Bold="True"></asp:Label>
                    <br />
                    <asp:Label ID="Label3" CssClass="text-center"  runat="server" Font-Bold="True"></asp:Label>
                <br />
                    <asp:Label ID="Label4" CssClass="text-center"  runat="server" Font-Bold="True"></asp:Label>
                <br />
            ...
            <div>
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="Black" BorderColor="Black" BorderStyle="Ridge" BorderWidth="2px" CellPadding="3" CellSpacing="1" DataSourceID="SqlDataSource1" OnRowDataBound="GridView1_RowDataBound">
                <Columns>
