<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminProfile.aspx.cs" Inherits="timetable_workshop.adminProfile" %>
    ...
    <form id = "form1" runat="server" class="form-signin">
        <div class="w3-blue-grey">
           ...
           <asp:Button ID="ButtonAdd" class="w3-bar-item w3-button" runat="server" Text="Add Admin" Font-Size="Medium" OnClick="ButtonAdd_Click" />
            <asp:Button ID="ButtonLogout" class="w3-bar-item w3-button float-right" runat="server" Text="Log Out" Font-Bold="False" OnClick="ButtonLogout_Click" Font-Size="Medium" />
        </div>
            <div class="container">
                <div class="card card-container" style="max-width:600px ">
                    ...
                    <div>
                        ...
                        &nbsp;<asp:Button ID="Button1" runat="server" Text="Upload" Width="100px" OnClick="Button1_Click" Height="28px" />
                        &nbsp;
                    ...
                    <p><asp:Button ID="Button2"  CssClass="btn btn-lg btn-primary btn-block btn-signin" runat="server" Text="Save Changes" OnClick="Button2_Click" />&nbsp;<asp:Button ID="Button3"  CssClass="btn btn-lg btn-primary btn-block btn-danger" runat="server" Text="Cancel" OnClick="Button3_Click" />&nbsp;</p>
                    <p>&nbsp;</p>
                    
                </div><!-- /card-container -->
            </div><!-- /container -->
                
                <%--<asp:Button ID="ButtonLogin" runat="server" Text="Sign in" class="btn btn-lg btn-primary btn-block btn-signin" Width="349px" OnClick="ButtonLogin_Click"/>--%>
    </form><!-- /form -->
