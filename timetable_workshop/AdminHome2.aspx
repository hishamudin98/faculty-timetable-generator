<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminHome2.aspx.cs" Inherits="timetable_workshop.AdminHome2" %>
    ...
    <form id="form1" runat="server">
        ...
        <div id="printablediv">
            ...
            <div>
                ...
                <br />
                <br />
                <asp:Label ID="LabelName" runat="server" Text="Select Course :" Font-Bold="True" Font-Size="Medium"></asp:Label>
                &nbsp;<asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" Width="215px">
                    <asp:ListItem>DIT</asp:ListItem>
                    <asp:ListItem>BITC</asp:ListItem>
                    <asp:ListItem>BITD</asp:ListItem>
                    <asp:ListItem>BITE</asp:ListItem>
                    <asp:ListItem>BITI</asp:ListItem>
                    <asp:ListItem>BITM</asp:ListItem>
                    <asp:ListItem>BITS</asp:ListItem>
                    <asp:ListItem>BITZ</asp:ListItem>
                </asp:DropDownList>
                <br />
                <br />
            ...
            <div class="auto-style5">
                <asp:Button ID="Button1" runat="server" Font-Bold="True" OnClick="Button1_Click" Text="Generate Timetable" Width="246px" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Button ID="Button3" runat="server" Font-Bold="True" Text="Clear all data in database" OnClick="Button3_Click" Width="274px" />
                    <br />
            </div>
                <br />
        <div class="auto-style6" >
            ...
            <div>
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="Black" BorderColor="Black" BorderStyle="Ridge" BorderWidth="2px" CellPadding="3" CellSpacing="1" CssClass="auto-style1" DataSourceID="SqlDataSource1" OnRowDataBound="GridView1_RowDataBound1" Width="1200px" Visible="False" DataKeyNames="ID">
                    <Columns>
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Timetable_proConnectionString3 %>" SelectCommand="SELECT * FROM [Timetable]"></asp:SqlDataSource>
