<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="lecturerHome.aspx.cs" Inherits="timetable_workshop.lecturerHome" %>
...
<body class="body">
    ...
    <form id="form1" runat="server">
        <div class="w3-blue-grey">
            ...
            <asp:Button ID="ButtonPDF" CssClass="w3-bar-item w3-button" runat="server" OnClientClick="printDiv('printablediv')" Text="Download Timetable PDF" Font-Size="Large" OnClick="ButtonPDF_Click" />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="Black" BorderColor="Black" BorderStyle="Ridge" BorderWidth="2px" CellPadding="3" CellSpacing="1" DataKeyNames="ID" DataSourceID="SqlDataSource1" OnRowDataBound="GridView1_RowDataBound">
                ...
                <HeaderStyle BackColor="#4A3C8C" Font-Bold="True" ForeColor="#E7E7FF" BorderColor="Black" />
